...
def analyze_reviews(reviews_list):
    ...
    ✅ ПЛЮСЫ ТОВАРА:
    - [перечисли только 3-5 самых важных плюсов очень кратко, одной строкой каждый]

    ❌ МИНУСЫ ТОВАРА:
    - [перечисли только 3-5 самых важных минусов очень кратко, одной строкой каждый]

    📝 ОБЩИЙ ВЫВОД:
    [краткое заключение о товаре в 1 предложениe]
    
    ВАЖНО: Ответ должен быть максимально лаконичным, не более 2000 символов в итоге.
